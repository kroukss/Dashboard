...
CadranTourParMin::CadranTourParMin(QGraphicsItem *parent)
{
    vitesse=0;
    value=8000; //Nombre de tours max
}
...
void CadranTourParMin::paint(QPainter *painter, const QStyleOptionGraphicsItem *option,QWidget *widget)
{    
QRect carre[13];
   for (int i=0;i<13;i++)
    {
...
int CadranTourParMin::getValueMax()
{
    return value;
}
...
void CadranTourParMin::setValue(int v)
{
    angle=(v-4000)*180./5300.;
}
